...
function buildTechnicalExport() {
  ...
  return {
    ...
    finalidade: 'Exportacao tecnica local para leitura por IA/suporte. Contem dados brutos e coletas agrupadas.',
    resumo: {
...
export default function Profile() {
  ...
  const loadStats = useCallback(() => {
    ...
    try {
      const count = AppDatabase.getFirst('SELECT COUNT(*) as count FROM respostas');
      setMonthCount(count?.count || 0);
